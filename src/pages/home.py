...
def write():
    ...
    st.markdown("<h1>Renovatie en restauratie van 19&#x1D49-eeuwse arbeiderswoningen in de Brugse binnenstad</h1>", unsafe_allow_html=True)
    ...
    #     src="https://www.youtube.com/watch?v=-UH3ERVfOys"
    # )

    ast.shared.components.video_youtube(
        # src="https://www.youtube.com/embed/E7pt2Zwg79g"
        src="https://www.youtube.com/embed/n0uNcoOwCok",
        height=395
    )
